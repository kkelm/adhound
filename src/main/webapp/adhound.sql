...
CREATE TABLE `user_roles` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `username_fk` (`username`),
...
INSERT INTO `user_roles` VALUES (1,'kkelm@email.com','Administrator'),(2,'distributor@email.com','Distributor'),(3,'runner@email.com','Runner');
...
INSERT INTO `users` VALUES (1,'kkelm@email.com','testPassword','Kevin','Kelm','(123) 456-7890','(123) 789-4560','kkelm@outlook.com','123 Test Road','Fitchburg',49,'12345-67890'),(2,'distributor@email.com','test','Darth','Vader','(123) 456-7890','(123) 789-4560','test@gmail.com','123 Test Street','Madison',25,'12345-67890'),(3,'runner@email.com','123abc','Luke','Skywalker','(123) 456-7890','(123) 789-4560','test@yahoo.com','123 Test Circle','Markesan',33,'12345-67890');
...
-- Dump completed on 2020-03-03 19:58:30
